/**
 * Fuente única de verdad del embudo de ventas (versión ES-LATAM).
 * Edita textos, precios, imágenes y enlaces de checkout AQUÍ — los componentes
 * solo consumen estos datos.
 *
 * Español neutro de Latinoamérica: sin "vosotros", sin pretérito perfecto
 * compuesto ("ya lo compraron", no "ya lo han comprado") y sin léxico
 * peninsular (celular/hoja/papelería, nunca móvil/folio/copistería).
 * Precios en dólares estadounidenses: $13.90 (punto decimal, símbolo delante).
 */
...
/** Checkouts de Hotmart (LATAM) — los precios de abajo deben coincidir con cada oferta. */
export const checkout = {
  /** Plan completo "Colección Maestra" — $13.90 (CTA principal). */
  master:
    "https://pay.hotmart.com/E107158670X?off=x2u7bywj&checkoutMode=10",
  /** Upsell del modal — $9.90 (plan completo con descuento). */
  upsell:
    "https://pay.hotmart.com/E107158670X?off=cdqcfpu9&checkoutMode=10",
  /** Plan básico — $6.90. */
  basic: "https://pay.hotmart.com/E107158670X?off=p1yb8d42&checkoutMode=10",
} as const;
...
export const productDemo = {
  ...
  subtitle:
    "Dale play y mira el producto por dentro: cómo lo recibes, cómo accedes y la calidad de las plantillas.",
  video: {
...
export const equipment: EquipmentItem[] = [
  {
    icon: Printer,
    title: "1. Impresora común",
    description:
      "Funciona en cualquier impresora casera A4 (de tinta o láser).",
  },
  {
    icon: FileText,
    title: "2. Papel económico",
    description:
      "Usa hoja normal de 75g para practicar o papel de 180g (lo consigues en cualquier papelería) para más durabilidad.",
  },
  {
    icon: Scissors,
 ...
 * Sustituir por testimonios reales del mercado latinoamericano antes de
 * publicar. Varios países de la región exigen que todo testimonio sea
 * comprobable (p. ej. PROFECO en México y el Código de Defensa del
 * Consumidor en Colombia y Argentina).
 */
...
export const testimonials: Testimonial[] = [
  {
    quote:
      "A mis hijos les encantaron y ahora cada día quieren una máscara nueva 🤣",
    author: "Aline Freire",
    role: "Mamá de 2",
  },
  {
    quote:
      "Las usé con mi grupo de 4º grado y les encantaron. Lo mejor es que las plantillas gustaron tanto a las niñas como a los niños.",
    author: "Clara Mendes",
    role: "Maestra",
  },
  {
...
export const pricing = {
  ...
  master: {
    ...
    socialProof: "648 personas ya lo compraron",
  },
  trustBadges: [
    "Compra 100% segura",
    "Descarga inmediata",
  ...
  guarantee: {
    ...
    text: "Estamos tan seguros de que te van a encantar las plantillas que te ofrecemos una garantía incondicional. Si no logras montarlas, no te gustan los modelos o simplemente cambias de opinión, te devolvemos el 100% de tu dinero. Sin preguntas, sin letra chica. Basta con un correo.",
  },
} as const;
...
export const upsell = {
  ...
  titleLead: "Desbloqueamos un",
  titleHighlight: "Descuento Secreto",
  titleTail: "para ti",
  description:
    "Te interesó el Plan Básico, pero ¿qué tal llevarte el Plan Completo con más de 500 plantillas por un precio exclusivo?",
...
export const faqs: Faq[] = [
  {
    ...
    answer:
      "En cuanto se apruebe el pago, recibes el acceso inmediatamente para descargar los archivos. Las plantillas se envían por WhatsApp y también por correo electrónico.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No. Solo hay que recortar, doblar y pegar. Con el primer modelo ya te sale solo.",
  },
  {
    question: "¿Qué papel debo usar? ¿Puedo usar hoja normal?",
    answer:
      '¡Sí! La hoja normal funciona muy bien y se monta sin problema. Aun así, si quieres un resultado más resistente y con un acabado más "premium", lo ideal es usar papel más firme, de 180g a 230g.',
  },
  {
    question: "¿Qué pegamento es mejor para montar?",
    answer:
      "El pegamento blanco escolar funciona perfectamente. El pegamento en barra también ayuda en las piezas más pequeñas.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No necesitas impresora en casa. Puedes imprimir en cualquier papelería o centro de copiado de tu ciudad. Y si tienes impresora, funciona perfectamente en cualquier impresora casera A4.",
  },
  {
